...
INSERT IGNORE INTO business_calendar (id, calendar_date, label, country_code)
VALUES
    (UNHEX(REPLACE(UUID(), '-', '')), '2026-01-01', 'Nouvel An', 'CM'),
    (UNHEX(REPLACE(UUID(), '-', '')), '2026-02-11', 'Fête de la Jeunesse', 'CM'),
    (UNHEX(REPLACE(UUID(), '-', '')), '2026-05-01', 'Fête du Travail', 'CM'),
    (UNHEX(REPLACE(UUID(), '-', '')), '2026-05-20', 'Fête Nationale', 'CM'),
    (UNHEX(REPLACE(UUID(), '-', '')), '2026-12-25', 'Noël', 'CM');
