...
public final class ChainTemplateMapper {
    ...
    public static ChainStepTemplateResponse toStepResponse(ChainStepTemplate step) {
        return new ChainStepTemplateResponse(
                ...
                step.getOrganization() != null ? step.getOrganization().getId() : null,
                step.getOrganization() != null ? step.getOrganization().getCode() : null,
                step.getOrganization() != null ? step.getOrganization().getName() : null,
                step.getDelayValue(),
                step.getDelayUnit(),
